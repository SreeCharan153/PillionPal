...
class RideTrackingPopup extends StatelessWidget {
  const RideTrackingPopup({super.key});
...
void showRideTrackingPopup(BuildContext context) {
  showModalBottomSheet(
    ...
    builder: (context) {
      return const RideTrackingPopup();
    },
  );
}
